    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{url('/')}}" target="_blank" class="sl-menu-link ">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
            <span class="menu-item-label">Visit web</span>
          </div><!-- menu-item -->
        </a>
        <a href="{{route('category.admin')}}"  class="sl-menu-link @yield('category')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
            <span class="menu-item-label">Category Item</span>
          </div><!-- menu-item -->
        </a>
        <a href="{{route('brand.admin')}}"  class="sl-menu-link @yield('brand')">
            <div class="sl-menu-item">
              <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
              <span class="menu-item-label">Brand Item</span>
            </div><!-- menu-item -->
          </a>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{ route('menage.product') }}" class="nav-link @yield('menage_product')">Menage Product</a></li>
      </ul>

      <a href="{{route('add.coupon')}}"  class="sl-menu-link @yield('Cuopon')">
        <div class="sl-menu-item">
          <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
          <span class="menu-item-label">Cuopon Item</span>
        </div><!-- menu-item -->
      </a>

      <a href="{{route('order.itame')}}"  class="sl-menu-link @yield('order')">
        <div class="sl-menu-item">
          <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
          <span class="menu-item-label">Order Item</span>
        </div><!-- menu-item -->
      </a>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="{{url('admin_log')}}"><i class="icon ion-power"></i> Sign Out</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
