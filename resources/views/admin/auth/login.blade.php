...
<form method="POST" action="{{ route('admin.login') }}">
 @csrf
  <div class="form-group">
    <input  type="email" class="form-control  @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Enter your E-Mail" autocomplete="email" autofocus>
        @error('email')
  ...
  <button type="submit" class="btn btn-info btn-block">  Sing up </button>  </form>
</div><!-- login-wrapper -->
</div><!-- d-flex -->
