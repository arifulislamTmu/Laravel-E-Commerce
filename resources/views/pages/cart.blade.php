                ...
                <div class="shoping__cart__table">
                    ...
                    @foreach ($carts as $cat )
                            ...
                            <tr>
                               ...
                               <form action="{{ url('Cart/update/'.$cat->id) }}" method="POST">
                                @csrf
                                    <div class="quantity">
                                        <div class="pro-qty">
                                            <input type="text" name="qty"value="{{ ($cat->qty) }}">
                                        </div>
                                ...
                                <td class="shoping__cart__item__close">
                                   <a href="{{ url('cart/product/delete/'.$cat->id) }}"><span class="icon_close"></span></a>
                                </td>
            ...
            <div class="col-lg-6">
                ...
                <div class="shoping__continue">
                    <div class="shoping__discount">
                        <h5>Coupon Codes</h5>
                        <form action="{{ url('Coupon/Code/') }}" method="POST">
                            @csrf
            ...
            <div class="col-lg-6">
                <div class="shoping__checkout">
                    ...
                    <ul>
                        ...
                        <li>Coupon Code <span>{{session()->get('coupon')['coupon_name']}} <a href="{{ url('Delete/coupon') }}"><span style="color:black;margin-left:6px;">X</span></a> </li>
                    ...
                    <a href="{{ url('Chekout/Order') }}" class="primary-btn">PROCEED TO CHECKOUT</a>
                </div>
            </div>
        </div>
    </div>
