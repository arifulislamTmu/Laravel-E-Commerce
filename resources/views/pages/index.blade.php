        ...
        <div class="container">
            ...
            <div class="row">
                <div class="categories__slider owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset($rows->brand_image1) }}">
                            <h5><a href="#">{{ $rows->product_name }}</a></h5>
                        </div>
                    </div>
                    @endforeach
                </div>
    ...
    <section class="featured spad">
        <div class="container">
            ...
            <div class="row featured__filter">
                ...
                @foreach ($categories as $category)
                @php
                  $products_all = App\Product::where('category_id',$category->id,)->latest()->get();
                @endphp
                @foreach ($products_all as $product )

                <div class="col-lg-3 col-md-4 col-sm-6 mix filter{{ $category->id }}">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{asset($product->brand_image1)}}">
                            ...
                            <div class="latest-prdouct__slider__item">
                                ...
                                <a href="#" class="latest-product__item">
                                    ...
                                    <div class="latest-product__item__pic">
                                        <img style="width:60px; height:50px" src="{{asset($rows->brand_image1)}}">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6>{{ $rows->product_name }}</h6>
                                        <span>${{ $rows->product_price }}</span>
                                    </div>
