            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="header__cart">
                        ...
                        $quanty = App\Cart::all()->where('user_ip',request()->ip())->sum('qty');
                        $wishqty = App\Wishlist::where('user_id',Auth::id())->get();
                        @endphp

                        <ul>
                            <li><a href="{{ url('wishlist/pages') }}"><i class="fa fa-heart"></i> <span>{{ count($wishqty) }}</span></a></li>
                            <li><a href="{{ url('Cart/page') }}"><i class="fa fa-shopping-bag"></i> <span>{{  $quanty }}</span></a></li>
                        </ul>
